...
<div class="added-game-card" data-game-id="${gameItem.gameId}">
    ...
    <div class="game-card-block-item char‑section">
        <button class="open‑char‑pool" data‑gid="${gameItem.gameId}">选择角色 Character</button>
        <div class="game-card-empty-tip char‑card‑wrapper char‑selected‑row" data‑gid="${gameItem.gameId}">${renderSelectedChar(gameItem, gameInfo)}</div>
    </div>

    <div class="game-card-block-item cp‑group">
        <button class="open‑cp‑pool" data‑gid="${gameItem.gameId}">选择角色 Couple</button>
        <div class="game-card-empty-tip cp‑render‑box" data‑gid="${gameItem.gameId}">${renderCP(gameItem, gameInfo)}</div>
    </div>
