        ...
        femaleChars.forEach(char => {
            ...
            <div class="char-item ${selected}" data-cid="${char.id}" data-char-id="${char.id}" data-game-id="${gameId}" data-total-img="${allSrc.length}" data-panel-mode="char">
              <div class="char-card-img-box ${allSrc.length>1?'char-multi-img':''}">
                ...
                <img src="${showSrc}" alt="${char.name}" decoding="async" loading="eager" style="image-rendering: -webkit-optimize-contrast;image-rendering: crisp-edges;">
            ...
            <div class="cp-female-block" data-fid="${fChar.id}" data-gid="${gameId}">
                ...
                <div class="cp-female-card-btn" 
                    ...
                    <div class="char-card-img-box ${allSrc.length>1?'char-multi-img':''}">
                        ...
                        <img src="${showSrc}" alt="${fChar.name}" decoding="async" loading="eager" style="image-rendering: -webkit-optimize-contrast;image-rendering: crisp-edges;">
                        ...
                        ${maleChars.map(mChar=>{
                            ...
                            <div class="cp-male-item ${mSel}" 
                                ...
                                <div class="char-card-img-box ${mSrcArr.length>1?'char-multi-img':''}">
                                    ...
                                    <img src="${mShowSrc}" alt="${mChar.name}" decoding="async" loading="eager" style="image-rendering: -webkit-optimize-contrast;image-rendering: crisp-edges;">
